...
if __name__ == '__main__':
    ...
    automaton = make_f110_rooms_model(use_throttle=not args.no_throttle, observe_heading=True, bad_start_region=args.bad_start_region)
    ...
    if args.monolithic_timesteps > 0:
        ...
        train_monolithic(
            ...
            args.monolithic_timesteps, [500, 100], args.path, args.verbose,
        )
