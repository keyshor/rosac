...
from hybrid_gym.envs.f110_obstacle_testing.mode import State
...
if __name__ == '__main__':
    ...
    bounds = dict(
        f110_straight_10m = (-2, 2, -5, 15),
        f110_square_right = (-2, 10, -10, 2),
        f110_square_left = (-10, 2, -10, 2),
        f110_sharp_right = (-2, 10, -10, 2),
        f110_sharp_left = (-10, 2, -10, 2),
        f110_obstacle = (-4, 4, -10, 10),
    )
    mode_name = sys.argv[1]
    test_x_low, test_x_high, test_y_low, test_y_high = bounds[mode_name]
