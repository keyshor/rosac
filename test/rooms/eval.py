...
if __name__ == '__main__':
    ...
    ap.add_argument('--no_mode_pred', action='store_true',
                    help='controls whether to use a mode predictor')
    ap.add_argument('--no_e2e', action='store_true',
